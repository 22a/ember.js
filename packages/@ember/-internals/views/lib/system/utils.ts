...
const ElementPrototype = (Element.prototype as unknown) as Dict<unknown>;
...
*/
export const elMatches: (selector: string) => boolean =
  ...
  ((ElementPrototype.matches ||
    ...
    ElementPrototype.webkitMatchesSelector) as any);
